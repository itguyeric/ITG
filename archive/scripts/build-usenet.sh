...
printf "\nCreating pod...\n\n"
/usr/bin/podman pod create --name usenet -p 1900:1900 -p 5353:5353 -p 6767:6767 -p 6789:6789 -p 7878:7878 -p 8686:8686 -p 8989:8989 -p 9091:9091 -p 32469:32469
...
#/usr/bin/podman generate kube usenet > pod-usenet.yaml
