...
/usr/bin/virt-resize --expand /dev/sda4 /var/lib/libvirt/templates/stream-latest.qcow2 /var/lib/libvirt/images/$SERVER.qcow2;
...
/usr/bin/virt-install --name $SERVER --memory 4096 --vcpus 2 --disk path=/var/lib/libvirt/images/$SERVER.qcow2 --import --os-variant centos-stream9 --network default --graphics vnc --noautoconsole --autostart
